...
def test_required_field_mismatch_names_the_differing_file(
    field, differing_value, field_label
):
    settings_list = [
        _settings("a.NEF"),
...
def test_white_balance_within_tolerance_passes():
    ...
    settings_list = [
        _settings("a.NEF"),
        _settings("b.NEF", camera_whitebalance=close_wb),
    ]
...
def test_white_balance_beyond_tolerance_names_differing_file():
    ...
    settings_list = [
        _settings("a.NEF"),
        _settings("b.NEF", camera_whitebalance=different_wb),
    ]
...
def test_white_balance_is_normalised_by_first_green_multiplier():
    ...
    settings_list = [
        _settings("a.NEF"),
        _settings("b.NEF", camera_whitebalance=scaled_wb),
    ]
