...
| --- | --- | --- |
| Profile | `ScannyBoy-Linear-v1.icc` | `ScannyBoy-Density-v1.icc` |
| TRC | parametric type 0, g = 1.0 | parametric type 0, **g = 2.2** |
| TRC claim | true — the pixels are linear | a **viewing convention** |
| Primaries | a **wide container**, not a measurement | a **wide container**, not a measurement |
