...
writes an empty v4 roll manifest. It emits `roll_created` carrying `roll_id`,
`roll_name`, and `path`.
...
| `ROLL_MANIFEST_UNSUPPORTED` | Roll manifest is not `manifest_format_version: 4` |
