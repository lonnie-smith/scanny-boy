...
extension CLICode {
    var friendlyTitle: String? {
        ...
        case .flatFieldReferenceLocked: "The flat-field reference is locked"
        case .flatFieldReferenceRigConflict: "The rig profile differs from the reference's"
        case .flatFieldHighlightClipped: "Flat-field correction clipped some highlights"
        case .rigProfileNotFound: "Rig profile not found"
